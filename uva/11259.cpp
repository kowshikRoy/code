 ...
 * second coin is used more than d[1] or d[2] times, respectively, let N12 be
 * the number of ways in which the first coin is used more than d[1] times, and
 * the second coin is used more than d[2] times. Then the number of ways in
 * which no coin is used more times than necessary is: N - N1 - N2 + N12.
 *
